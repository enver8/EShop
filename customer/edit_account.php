...
<form action="" method="POST" enctype="multipart/form-data"><!-- form Begin -->
    ...
    <div class="form-group"><!-- form-group Begin -->
        ...
        <input type="text" name="c_namecontact" class="form-control" value="<?php echo $customer_contact; ?>" required>
...
if(isset($_POST['update'])){
    ...
    $update_customer = "update customers set customer_name='$c_name'customer_email='$c_email',customer_country='$c_country',customer_city='$c_city',cutomer_address='$c_address',customer_contact='$c_contact',customer_image='$c_image' where customer_id='$update_id'";
