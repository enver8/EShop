                    ...
                    <div class="col-sm-6"><!-- col-sm-6 Begin -->
                        <div id="mainImage"><!-- #mainImage Begin -->
                            <div id="MyCarousel" class="carousel slide" data-ride="carousel"><!-- carousel slide Begin -->
                                <ol class="carousel-indicators"><!-- carousel-indicator Begin -->
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="item">
                                        <center><img class="img-responsive" src="admin_area/product_images/<?php echo "$pro_img2"; ?>" alt="Product 1-A"></center>
                                    </div>
                                    <div class="item">
                                        <center><img class="img-responsive" src="admin_area/product_images/<?php echo "$pro_img3"; ?>" alt="Product 1_B"></center>
                                    </div>
                                </div>
                                ...
                                </a><!-- right carousel-control slide Finish -->
                    ...
                    <div class="col-sm-6"><!-- col-sm-6 Begin -->
                        <div class="box"><!-- box Begin -->
                            ...
                            <form action="details.php?add_cart=<?php echo "$product_id" ; ?>" class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                                ...
                                <p class="price"><?php echo "$pro_price" ; ?>,00 BAM</p>

                                <p class="text-center buttoms"><button class="btn btn-primary i fa fa-shopping-cart"> Add to cart</button></p>
